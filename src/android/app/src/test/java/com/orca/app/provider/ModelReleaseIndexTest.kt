 ...
 * stale (or uncallable) model off the top of a picker — see I#83.
 *
...
class ModelReleaseIndexTest {
    ...
    @Test
    fun `two undated models still order deteritically by name`() {
    ...
    /**
     * End-to-end shape of the I#83 scenario: ranking the Codex OAuth ids
