...
import com.i.app.ui.navigation.AppNavigation
import com.i.app.ui.navigation.Routes
import com.i.app.ui.navigation.safeNavigate
import com.i.app.ui.shell.AppShell
import com.i.app.ui.settings.KEY_FONT_APP_BASE
import com.i.app.ui.settings.KEY_KEEP_SCREEN_AWAKE
import com.i.app.ui.settings.KEY_LANGUAGE
import com.i.app.ui.settings.KEY_LAUNCH_SESSION
import com.i.app.ui.settings.KEY_THEME_MODE
import com.i.app.ui.settings.PREF_APPEARANCE
...
class MainActivity : ComponentActivity() {
     ...
     * [com.i.app.ui.navigation.AppNavigation]'s LaunchedEffect that
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(com.i.app.i18n.LocaleWrap.wrap(newBase))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (iApp == null || !iApp.subsystemsInitialized) {
            android.util.Log.w(
                ...
                "app subsystems not initialized (safeMode=" +
                    "${com.i.app.crash.CrashFrequencyDetector.isSafeMode()}) — " +
                    "showing crash share dialog and finishing",
            )
            com.i.app.crash.CrashFrequencyDetector.maybeShowOnActivity(
                activity = this,
        ...
        restoredChatSessionId = savedInstanceState?.getString(KEY_CURRENT_CHAT_SESSION_ID)
            ?.takeUnless {
                com.i.app.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(this)
            }
        ...
        com.i.app.share.ShareCoordinator.processPendingShare(this)
        ...
        if (BuildConfig.DEBUG) {
            com.i.app.debug.DebugRPCHandler.currentActivity = java.lang.ref.WeakReference(this)
        }
        ...
        setContent {
            ...
            ITheme(darkTheme = darkTheme, fontScale = fontScale) {
                ...
                com.i.app.ui.settings.ConfigConfirmDialogHost()
            }
        }
    }
     ...
     * is already covered by [com.i.app.ui.navigation.AppNavigation]
