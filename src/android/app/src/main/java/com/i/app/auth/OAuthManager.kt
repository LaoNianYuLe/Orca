...
abstract class OAuthManager(
    ...
    companion object {
        ...
        fun forInstance(context: Context, instance: com.i.app.data.model.ProviderInstance): OAuthManager? {
            return when (instance.providerType) {
                com.i.app.data.model.ProviderType.anthropic -> ClaudeOAuthManager(context, instance.id)
                com.i.app.data.model.ProviderType.openAI -> OpenAIOAuthManager(context, instance.id)
                com.i.app.data.model.ProviderType.xAI -> XAIOAuthManager(context, instance.id)
                com.i.app.data.model.ProviderType.kimiCode -> KimiOAuthManager(context, instance.id)
                else -> null
            }
        }
    }
    ...
    private fun getEncryptedPrefs() =
        com.i.app.util.EncryptedPrefsFactory.safeCreate(context, "oauth_prefs")
