...
/**
 * One configurable setting. Concrete kinds: [com.i.app.config.fields.PrefsBoolField]
 * etc. for SharedPreferences-backed scalars; [com.i.app.config.fields.ClosureField]
