...
import com.i.app.offload.ShizukuManager
...
fun OffloadPermissionScreen(
    ...
    val configEnabled by com.i.app.config.IConfigPermissionStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = {
                    com.i.app.config.IConfigPermissionStore.setEnabled(it)
                },
                showDivider = false,
            )
        }
        ...
        AlertDialog(
            ...
            confirmButton = {
                ITextButton(onClick = {
                    ...
                    com.i.app.config.IConfigPermissionStore.setEnabled(true)
