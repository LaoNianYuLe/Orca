package com.i.app.provider.openai
...
import com.i.app.provider.failOnSilentEmptyCompletion
...
class OpenAIProvider private constructor(
     ...
     * user-authored custom rules from [com.i.app.provider.thinking.ThinkingRuleResolver]'s
    ...
    private val client = OkHttpClient.Builder()
        ...
        .connectionPool(com.i.app.network.NetworkMonitor.sharedLLMConnectionPool)
    ...
    private fun rawStreamMessage(
        ...
        val memBefore = com.i.app.diagnostics.MemorySnapshot.capture()
        val serStartNs = System.nanoTime()
        val bodyStr = try {
            body.toString()
        } catch (t: Throwable) {
            com.i.app.diagnostics.LargeAllocProbe.report(
                "openai.body.toString", -1, "model=${model.id} messages=${messages.size}",
                memBefore, serStartNs, failure = t,
            )
            throw t
        }
        if (bodyStr.length >= com.i.app.diagnostics.LargeAllocProbe.NOTABLE_BYTES) {
            com.i.app.diagnostics.LargeAllocProbe.report(
        ...
        if (!response.isSuccessful) {
            ...
            com.i.app.logging.AppLogger.error(
                "OpenAIProvider",
            ...
            if (com.i.app.BuildConfig.DEBUG) {
                com.i.app.debug.LLMRequestLog.add(
                    com.i.app.debug.LLMRequestLog.Entry(
                        provider = "openai",
                ...
                run {
                    ...
                    if (delta != null) {
                        ...
                        if (cLen + rcLen + rLen + tcLen > 0 || delta.has("role")) {
                            com.i.app.logging.AppLogger.debug(
                                "OpenAIProvider",
                                    ...
                                    when (part) {
                                        ...
                                        is AgentContentPart.ImageData -> {
                                            if (supportsImages) {
                                                ...
                                                val safeBytes = com.i.app.provider.ImageBudget.compressUnderBudget(part.data)
    ...
    private fun responsesImageBlock(
        ...
        // T-imgsize: provider-boundary backstop.
        val safeBytes = com.i.app.provider.ImageBudget.compressUnderBudget(data)
    ...
    private fun buildResponsesAPIBody(
        ...
        if (com.i.app.data.FastModePrefs.isEnabled() &&
                        ...
                        if (imgParts.isNotEmpty()) {
                            ...
                            for (part in msg.contentParts) {
                                when (part) {
                                    ...
                                    else -> com.i.app.logging.AppLogger.error(
                                        "OpenAIProvider",
