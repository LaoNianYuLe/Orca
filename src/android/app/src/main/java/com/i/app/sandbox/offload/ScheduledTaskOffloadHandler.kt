...
import com.i.app.scheduled.ScheduledRepeatMode
import com.i.app.scheduled.ScheduledTargetMode
import com.i.app.scheduled.ScheduledTask
import com.i.app.scheduled.ScheduledTaskManager
...
class ScheduledTaskOffloadHandler(private val context: Context) : NativeOffloadHandler {
    ...
    private fun handleRun(args: OffloadArgs): NativeOffloadResult {
        ...
        val sessionId = runBlocking {
            com.i.app.scheduled.ScheduledAgentRunner.run(context, task)
        }
        val out = JSONObject()
            .put("id", id)
