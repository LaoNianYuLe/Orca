...
class PersistentShell(
    ...
    private fun startProcess() {
        ...
        val debugOffload = com.i.app.BuildConfig.DEBUG
        ...
        // __I_DONE__ marker detection). Release keeps the original
        ...
        try {
            ...
            while (true) {
                ...
                if (cb != null) {
                    ...
                    val markerExitPattern = "__I_DONE_${cb.marker}_EXIT_"
    ...
    private fun parseExitCode(text: String, marker: String): Int {
        // Pattern: __I_DONE_{marker}_EXIT_{code}__
        val regex = Regex("__I_DONE_${Regex.escape(marker)}_EXIT_(\\d+)__")
     ...
     *   {command}; echo "__I_DONE_{marker}_EXIT_$?__"
     *
    ...
    suspend fun executeCommand(
        ...
        val wrappedCommand = "$command\necho \"__I_DONE_${marker}_EXIT_\$?__\"\n"
