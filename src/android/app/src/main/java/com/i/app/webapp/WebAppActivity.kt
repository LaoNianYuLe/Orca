...
class WebAppActivity : ComponentActivity() {
     ...
     * screen offering an "Open in I" escape hatch.
     */
                    ...
                    Box(
                        ...
                        Card(modifier = Modifier.padding(24.dp)) {
                            Column(
                                ...
                                Button(onClick = { openInI(sourceSessionId) }) {
                                    Text(stringResource(R.string.webapp_open_in_i))
                                }
                            }
                        }
                    }
    ...
    private fun openInI(sourceSessionId: String?) {
    ...
    companion object {
        ...
        const val ACTION_OPEN_WEBAPP = "com.i.app.action.OPEN_WEBAPP"
