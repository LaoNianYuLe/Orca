...
import com.i.app.R
import com.i.app.ui.components.openExternalUrl
        ...
        Column(
            ...
            SettingsSection(title = stringResource(R.string.settings_section_about)) {
                SettingsItem(
                    ...
                    iconColor = Color(0xFF007AFF),
                    title = stringResource(R.string.settings_about_i),
                ...
                SettingsItem(
                    ...
                    onClick = { openExternalUrl(context, "https://i.github.io/privacy-policy.html") },
                )
                SettingsItem(
...
private fun buildBugReportUrl(): String {
    ...
    val body = """
        ...
        | I Version | $versionName (build $versionCode) |
...
private fun buildFeedbackMailto(): String {
    ...
    """.trimIndent()
    val subject = java.net.URLEncoder.encode("Orca Feedback", "UTF-8")
    val encodedBody = java.net.URLEncoder.encode(body, "UTF-8")
    return "mailto:dev@i.app?subject=$subject&body=$encodedBody"
}
