...
import com.i.app.provider.voice.VoiceInputRequest
import com.i.app.provider.voice.VoiceProvider
import com.i.app.provider.voice.VoiceProviderException
import com.i.app.provider.voice.VoiceProviderFactory
...
class ProviderSpeechRecognitionEngine(private val appContext: Context) : SpeechRecognitionEngine {
    ...
    private fun startVadCapture(
        locale: Locale,
        repo: com.i.app.data.repository.ProviderRepository,
        candidates: List<Pair<com.i.app.data.model.ProviderInstance, com.i.app.data.model.ModelEntry>>,
