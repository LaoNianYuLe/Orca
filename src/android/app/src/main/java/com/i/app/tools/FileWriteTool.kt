...
object FileWriteTool {
    ...
    fun execute(argsJson: String, sessionId: String, context: Context): ToolExecutionResult {
        return try {
            ...
            // T123: per-session resolver so /var/i/workspace/...,
            // /var/i/attachments/..., /var/i/offloads/...,
            // /var/i/browser/... land in this session's host dir
            ...
            // /var/i/workspace/foo/bar.md would otherwise hit "Parent
            ...
            if (path.startsWith("/var/i/mounts/")) {
