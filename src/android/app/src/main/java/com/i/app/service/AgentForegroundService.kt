...
class AgentForegroundService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_STOP = "com.i.app.STOP_AGENT_SERVICE"
    ...
    private fun acquireWakeLock() {
        ...
        try {
            ...
            wakeLock = pm.newWakeLock(
                ...
                // No timeout — release happens deteritically in onDestroy
    ...
    private fun buildNotification(sessionCount: Int, toolStatus: String): Notification {
        ...
        val mainIntent = Intent(this, Class.forName("com.i.app.MainActivity")).apply {
    ...
    private fun toolDisplayLabel(toolName: String): String = when (toolName) {
        "shell_execute" -> "Orca is using Shell"
        "file_read" -> "Orca is reading File"
        "file_write" -> "Orca is using Editor"
        "file_edit" -> "Orca is editing File"
        "browser_use" -> "Orca is using Browser"
        "read_image" -> "Orca is reading Image"
        "memory_write", "memory_get" -> "Orca is using Memory"
        "web_search" -> "Orca is using Search"
        else -> "Orca is using $toolName"
    }
