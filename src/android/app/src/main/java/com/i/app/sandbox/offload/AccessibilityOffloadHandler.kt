...
import com.i.app.accessibility.IAccessibilityService
import com.i.app.accessibility.NodeRegistry
...
First-run: enable "Orca" under Settings → Accessibility, then `service ping`.
"""
...
"""
    ...
    override fun handle(request: NativeOffloadRequest): NativeOffloadResult {
            ...
            if (!usable) {
                return err(
                    ...
                    "Accessibility permission was revoked (this happens after a force-stop). " +
                        "Re-enable Orca under Settings → Accessibility, or use Settings → " +
        ...
        com.i.app.service.SessionActivityTracker.updateToolStatus(
        ...
        return try {
            ...
            err(args, "SERVICE_NOT_RUNNING",
                e.message ?: "Accessibility service is not running. Enable Orca under Settings → Accessibility.",
                exit = 77)
        } catch (e: Throwable) {
