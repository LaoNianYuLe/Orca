package com.i.app.provider.gemini
...
class GeminiProvider(
    ...
    override suspend fun sendMessageClamped(
        ...
        val request = Request.Builder()
            ...
            // can trace the request back to the I build. Gemini has no
    ...
    private fun rawStreamMessage(
        ...
        val request = Request.Builder()
            ...
            // branch above — brand outbound requests with I/<version>.
            .applyUserAgentOverride(null)
            .build()
    ...
    private fun buildRequestBody(
        ...
        // [I#226] Audio-output models reject systemInstruction with 400
