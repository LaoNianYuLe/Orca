...
import com.i.app.debug.HeadlessChatRunner
import com.i.app.logging.AppLogger
import com.i.app.service.AgentForegroundService
...
object ScheduledAgentRunner {
    ...
    private suspend fun resolveSessionId(app: IApp, task: ScheduledTask): String? {
        return when (val mode = task.targetMode) {
            ...
            ScheduledTargetMode.NewSession -> {
                ...
                val memoryOn = com.i.app.data.MemoryGlobalPrefs.isGlobalEnabled(app)
    ...
    private fun postCompletionNotification(
        ...
        val title = "Orca: ${task.label.ifBlank { "Scheduled task" }}"
