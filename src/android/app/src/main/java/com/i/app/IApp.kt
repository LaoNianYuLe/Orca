...
import com.i.app.data.db.AppDatabase
import com.i.app.data.repository.BackgroundSettingsRepository
import com.i.app.data.repository.ChatRepository
import com.i.app.data.repository.EnvVarRepository
import com.i.app.data.MountedFoldersStore
import com.i.app.data.repository.MemoryRepository
import com.i.app.data.repository.ProviderRepository
import com.i.app.data.repository.WebAppShortcutRepository
import com.i.app.data.repository.MCPRepository
import com.i.app.data.repository.SkillRepository
import com.i.app.notification.BackgroundTaskNotifier
import com.i.app.logging.AppLogger
import com.i.app.network.NetworkMonitor
import com.i.app.offload.OffloadPermissionManager
import com.i.app.provider.ModelsDevApi
import com.i.app.sandbox.ExecutionCoordinator
import com.i.app.sandbox.MountedFolderCoordinator
import com.i.app.sandbox.NativeOffloadServer
import com.i.app.sandbox.PRootKernel
import com.i.app.sandbox.RootfsManager
import com.i.app.sandbox.offload.AccessibilityOffloadHandler
import com.i.app.sandbox.offload.AlarmOffloadHandler
import com.i.app.sandbox.offload.BrowserUseOffloadHandler
import com.i.app.sandbox.offload.CalendarOffloadHandler
import com.i.app.sandbox.offload.ClipboardOffloadHandler
import com.i.app.sandbox.offload.ContactsOffloadHandler
import com.i.app.sandbox.offload.DeviceOffloadHandler
import com.i.app.sandbox.offload.LocationOffloadHandler
import com.i.app.sandbox.offload.ModelUseOffloadHandler
import com.i.app.sandbox.offload.SessionsOffloadHandler
import com.i.app.sandbox.offload.ShizukuOffloadHandler
import com.i.app.sandbox.offload.NotificationOffloadHandler
import com.i.app.sandbox.offload.OpenOffloadHandler
import com.i.app.sandbox.offload.PhotosOffloadHandler
import com.i.app.sandbox.offload.PlayerOffloadHandler
import com.i.app.sandbox.offload.SpeakOffloadHandler
import com.i.app.sandbox.offload.SpeechOffloadHandler
import com.i.app.sandbox.offload.WeatherOffloadHandler
import com.i.app.service.SessionActivityTracker
import com.i.app.ui.IImageFetcher
...
class IApp : Application(), ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        com.i.app.data.FastModePrefs.prime(this)
        ...
        // Activity context.
        com.i.app.data.AutoCompactPrefs.prime(this)
        ...
        // libs first execute.
        try {
            com.i.app.crash.NativeCrashHandler.install(
            ...
            Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
                try {
                    ...
                    if (isFgsTimeout) {
                        ...
                        runCatching {
                            val intent = Intent(this, com.i.app.service.AgentForegroundService::class.java)
                            stopService(intent)
                        }
                    }
                } catch (t: Throwable) {
        ...
        com.i.app.crash.CrashFrequencyDetector.checkAtLaunch(this)
        ...
        // [com.i.app.diagnostics.LaunchCycleBeacon].
        try {
            com.i.app.diagnostics.LaunchCycleBeacon.recordLaunch(this)
        } catch (t: Throwable) {
        ...
        com.i.app.diagnostics.HangDetector.start(this)
        ...
        com.i.app.agent.SoulStore.ensureExists(this)
        com.i.app.agent.SoulStore.refreshCache(this)
        ...
        com.i.app.config.IConfigPermissionStore.init(this)
        com.i.app.config.audit.ConfigAuditLog.init(this)
        com.i.app.config.ConfigRegistry.init(
        ...
        com.i.app.data.EnvVarPrivacyStore.init(this)
        com.i.app.data.EnvVarRedactor.envVarRepository = envVarRepository
        ...
        NativeOffloadServer.register(
            "i-config",
            com.i.app.sandbox.offload.ConfigOffloadHandler(),
        )
        ...
        NativeOffloadServer.register(
            "i-scheduled",
            com.i.app.sandbox.offload.ScheduledTaskOffloadHandler(this),
        )
        ...
        com.i.app.offload.ShizukuManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            NativeOffloadServer.register(
                "i-debug",
                com.i.app.sandbox.offload.DebugOffloadHandler(this),
            )
        }
        ...
        com.i.app.service.SessionBadgeStore.init(this)
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            ...
            com.i.app.service.SessionBadgeStore.reconcileInterruptedSessions(interrupted - active)
        }
        ...
        val configConfirmNotifier = com.i.app.notification.ConfigConfirmNotifier(
            context = this,
            backgroundSettings = backgroundSettingsRepository,
            isAppForeground = ::isAppForeground,
        )
        com.i.app.config.confirm.ConfigConfirmationGate.backgroundNotifier = {
            configConfirmNotifier.notifyIfBackgrounded(it)
        }
        com.i.app.config.confirm.ConfigConfirmationGate.cancelNotification = {
        ...
        registerActivityLifecycleCallbacks(object : ActivityLifecycleCallbacks {
            ...
            override fun onActivityResumed(activity: Activity) {
                ...
                com.i.app.crash.CrashFrequencyDetector.maybeShowOnActivity(activity)
            ...
            override fun onActivityStopped(activity: Activity) {
                ...
                if (foregroundActivityCount == 0) {
                    ...
                    com.i.app.config.confirm.ConfigConfirmationGate.notifyPending()
                }
            }
        ...
        com.i.app.speech.SpeechRecognitionManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            try {
                com.i.app.debug.DebugServer(this).start()
            } catch (e: Exception) {
        ...
        // system Clock app. Pre-T266 builds wrote alarms into I's own
        // SharedPreferences + AlarmManager; T266 retired that path but old
        // installs still have ghost entries that fire only inside I.
    ...
    override fun onTrimMemory(level: Int) {
        ...
        runCatching { com.i.app.ui.chat.KatexWebViewPool.evictAll() }
            .onFailure { Log.w("IApp", "KatexWebViewPool.evictAll failed: ${it.message}") }
        runCatching { com.i.app.ui.markdown.KaTeXRendererCache.evictAll() }
        ...
        if (level >= TRIM_MEMORY_COMPLETE) {
            ...
            runCatching { com.i.app.ui.chat.KatexWebViewPool.releaseWebView() }
    ...
    override fun onTerminate() {
        ...
        try {
            com.i.app.diagnostics.LaunchCycleBeacon.recordCleanExit(this)
        } catch (t: Throwable) {
