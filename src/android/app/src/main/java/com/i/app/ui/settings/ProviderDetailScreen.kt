...
import com.i.app.ui.util.bringIntoViewOnFocus
import com.i.app.R
import kotlinx.coroutines.launch
import com.i.app.ui.components.IButton
import com.i.app.ui.components.IOutlinedButton
import com.i.app.ui.components.ISmallButton
import com.i.app.ui.components.ISmallOutlinedButton
import com.i.app.ui.components.ISmallTextButton
import com.i.app.ui.components.ITextButton
import com.i.app.ui.components.SectionTextField
...
fun ProviderDetailScreen(
    ...
    var entryToDelete by remember { mutableStateOf<com.i.app.data.model.ModelEntry?>(null) }
    ...
    SettingsScaffold(
        ...
        if (instance.providerType != ProviderType.openRouter) {
            SettingsSection(header = stringResource(R.string.provider_detail_custom_api_base)) {
                ...
                // gateways reject I' default UA and only allow official
        ...
        // Picks how i-model-use routes image-output models:
        ...
        if (instance.supportsImageEndpointSetting) {
            ...
            SettingsSection(
                ...
                footer = when (mode) {
                    com.i.app.data.model.ImageEndpointMode.auto ->
                ...
                SettingsCardBlock {
                    SingleChoiceSegmentedButtonRow(modifier = Modifier.fillMaxWidth()) {
                        SegmentedButton(
                            selected = mode == com.i.app.data.model.ImageEndpointMode.auto,
                            onClick = {
                                if (mode != com.i.app.data.model.ImageEndpointMode.auto) {
                                    providerRepository.updateInstance(
                                        instance.copy(
                                            imageEndpointMode = com.i.app.data.model.ImageEndpointMode.auto,
                                        ),
                                    )
                                }
                            },
                        ...
                        SegmentedButton(
                            selected = mode == com.i.app.data.model.ImageEndpointMode.imagesGenerations,
                            onClick = {
                                if (mode != com.i.app.data.model.ImageEndpointMode.imagesGenerations) {
                                    providerRepository.updateInstance(
                                        instance.copy(
                                            imageEndpointMode = com.i.app.data.model.ImageEndpointMode.imagesGenerations,
                        ...
                        SegmentedButton(
                            selected = mode == com.i.app.data.model.ImageEndpointMode.chatCompletions,
                            onClick = {
                                if (mode != com.i.app.data.model.ImageEndpointMode.chatCompletions) {
                                    providerRepository.updateInstance(
                                        instance.copy(
                                            imageEndpointMode = com.i.app.data.model.ImageEndpointMode.chatCompletions,
                                            imageEndpointResolved = null,
                                        ),
                                    )
                                }
...
private fun OAuthCredentialBlock(
    ...
    var kimiDeviceAuth by remember(instance.id) {
        mutableStateOf<com.i.app.auth.KimiDeviceFlow.DeviceAuthorization?>(null)
    }
    ...
    if (displayedKey.isNotEmpty()) {
        ISmallButton(
            onClick = {
                ...
                com.i.app.auth.OAuthManager.forInstance(context, instance)?.logout()
                    ...
                    try {
                        val token = when (instance.providerType) {
                            ProviderType.kimiCode ->
                                com.i.app.auth.KimiOAuthManager.login(
                                    context, instance.id, providerRepository,
                                    onDeviceCode = { auth -> kimiDeviceAuth = auth },
                                ).also { kimiDeviceAuth = null }
                            ProviderType.anthropic ->
                                com.i.app.auth.ClaudeOAuthManager.login(
                                    context, instance.id, providerRepository,
                                )
                            ProviderType.openAI ->
                                com.i.app.auth.OpenAIOAuthManager.login(
                                    context, instance.id, providerRepository,
                                )
                            ProviderType.openRouter ->
                                com.i.app.auth.OpenRouterOAuthManager.login(
                                    context, instance.id, providerRepository,
                                )
                            ProviderType.xAI ->
                                com.i.app.auth.XAIOAuthManager.login(
                                    context, instance.id, providerRepository,
                                )
                            else -> null
                        }
...
private fun ManualBearerTokenSection(
    ...
    val manager = remember(instance.id) {
        com.i.app.auth.OAuthManager.forInstance(context, instance)
    }
