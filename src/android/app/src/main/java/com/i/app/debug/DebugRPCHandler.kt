...
class DebugRPCHandler(private val context: Context) {
    ...
    private fun crashSummary(f: File): String = try {
        ...
        val frame = body.firstOrNull { it.trimStart().startsWith("at com.i") }
    ...
    private suspend fun handleShellExecute(params: JSONObject): JSONObject {
        ...
        val result = try {
            ExecutionCoordinator.execute(
                ...
                lineCallback = { rawLine ->
                    val (_, urls) = com.i.app.terminal.IUrlMarker.extract(rawLine)
        ...
        for (raw in capturedUrls) {
            com.i.app.terminal.IOpenUrlBroker.offer(raw)
        }
        return JSONObject()
    ...
    private suspend fun handleUpdateCheck(): JSONObject {
        return when (val r = com.i.app.data.UpdateChecker.check()) {
            is com.i.app.data.UpdateChecker.CheckResult.UpdateAvailable -> JSONObject()
            ...
            com.i.app.data.UpdateChecker.CheckResult.UpToDate ->
                JSONObject().put("status", "up_to_date")
            com.i.app.data.UpdateChecker.CheckResult.NoReleaseAvailable ->
                JSONObject().put("status", "no_release")
            is com.i.app.data.UpdateChecker.CheckResult.NoApkAsset ->
                JSONObject().put("status", "no_apk_asset").put("tag_name", r.tagName)
            com.i.app.data.UpdateChecker.CheckResult.Forbidden ->
                JSONObject().put("status", "forbidden")
            com.i.app.data.UpdateChecker.CheckResult.NetworkUnreachable ->
                JSONObject().put("status", "network_unreachable")
            is com.i.app.data.UpdateChecker.CheckResult.Error ->
    ...
    private suspend fun handleUpdateDownload(params: JSONObject): JSONObject {
        ...
        return when (val r = com.i.app.data.UpdateChecker.download(context, url)) {
            is com.i.app.data.UpdateChecker.DownloadResult.Success -> JSONObject()
                .put("status", "ok")
                .put("path", r.file.absolutePath)
                .put("size", r.file.length())
            is com.i.app.data.UpdateChecker.DownloadResult.Error -> JSONObject()
                .put("status", "error")
    ...
    private fun handleUpdateInstall(params: JSONObject): JSONObject {
        ...
        val canInstall = com.i.app.data.UpdateChecker.canInstall(context)
        return try {
            com.i.app.data.UpdateChecker.installApk(context, file)
    ...
    private fun handleWriteFile(params: JSONObject): JSONObject {
        ...
        val hostFile = PRootKernel.resolveHostPath(path) ?: run {
            val rootfsDir = com.i.app.sandbox.RootfsManager.getInstance(context).rootfsDir
    ...
    private fun handlePermissionsList(): JSONObject {
        ...
        for (tool in com.i.app.offload.OffloadPermissionManager.toolRegistry) {
            arr.put(JSONObject()
                ...
                .put("currentLevel", com.i.app.offload.OffloadPermissionManager.getLevel(tool.toolName).name)
    ...
    /**
     * T344: Direct invocation of [com.i.app.sandbox.offload.ShizukuOffloadHandler]
    ...
    private fun handleShizukuExec(params: JSONObject): JSONObject {
        ...
        val handler = com.i.app.sandbox.offload.ShizukuOffloadHandler(context)
        ...
        val request = com.i.app.sandbox.NativeOffloadRequest(
            pid = -1,
    ...
    /**
     * Direct invocation of [com.i.app.sandbox.offload.ModelUseOffloadHandler]
    ...
    private fun handleModelUseExec(params: JSONObject): JSONObject {
        ...
        val finalArgv: List<String> = if (params.has("input")) {
            ...
            val hostFile = com.i.app.sandbox.PRootKernel.resolveHostPath(linuxPath)
        ...
        val app = context.applicationContext as com.i.app.IApp
        val handler = com.i.app.sandbox.offload.ModelUseOffloadHandler(context, app.providerRepository)
        val request = com.i.app.sandbox.NativeOffloadRequest(
            pid = -1,
     ...
     * [com.i.app.sandbox.offload.SessionsOffloadHandler] for e2e
    ...
    private fun handleSessionsExec(params: JSONObject): JSONObject {
        ...
        val app = context.applicationContext as com.i.app.IApp
        val handler = com.i.app.sandbox.offload.SessionsOffloadHandler(app.chatRepository)
        val request = com.i.app.sandbox.NativeOffloadRequest(
            pid = -1,
     ...
     */
    private fun handleIConfigExec(params: JSONObject): JSONObject {
        ...
        return when (sub) {
            "set" -> {
                ...
                kotlinx.coroutines.runBlocking {
                    com.i.app.config.ConfigBridge.performWriteBatch(
                        items = items,
            ...
            "get" -> {
                ...
                com.i.app.config.ConfigBridge.readField(
                    path = path,
                    filter = filter,
                    page = page,
                    pageSize = pageSize,
            ...
            "topics" -> JSONObject().apply {
                put("ok", true)
                put("topics", com.i.app.config.ConfigBridge.allTopics())
            }
            "topic-help" -> {
            ...
            "audit-list" -> {
                ...
                com.i.app.config.ConfigBridge.auditList(limit, scope)
            }
