 ...
 * [MainActivity], which [com.i.app.deeplink.DeepLinkHandler] parses
 * into [com.i.app.deeplink.DeepLinkAction.OpenHtmlPreview]; the
...
object WebPreviewShortcut {
     ...
     * character on a colored disc. Color is picked deteritically
