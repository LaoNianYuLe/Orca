package com.i.app.notification
 ...
 *
 * Trigger contract: this class is hooked into [com.i.app.service.SessionActivityTracker]
...
class BackgroundTaskNotifier(
    ...
    /**
     * Called by [com.i.app.service.SessionActivityTracker] when a
