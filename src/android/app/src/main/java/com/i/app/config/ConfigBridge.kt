...
import com.i.app.config.audit.ConfigAuditActor
import com.i.app.config.audit.ConfigAuditEntry
import com.i.app.config.audit.ConfigAuditLog
import com.i.app.config.audit.ConfigAuditStatus
import com.i.app.config.confirm.ConfigConfirmationGate
import com.i.app.config.confirm.ConfirmOutcome
import com.i.app.config.confirm.PendingConfigChange
import com.i.app.config.confirm.PendingConfigChangeItem
 ...
 * in [com.i.app.sandbox.NativeOffloadResult]. The handler
        ...
        return when (outcome) {
            is ConfirmOutcome.TimedOut -> {
                ...
                JSONObject().apply {
                    ...
                    put("user_message", "Orca waited but you didn't confirm the change. Tap me again if you want me to retry.")
                }
            }
            ...
            is ConfirmOutcome.Approved -> {
                ...
                if (applied.length() == 0 && earlyError != null) {
                    ...
                    JSONObject().apply {
                        ...
                        put("audit_url", "i://settings/logs?tab=config-audit")
                        put("user_message", "Settings updated. Review or revert at [Logs → Config Changes](i://settings/logs?tab=config-audit).")
                    }
                }
            }
        }
