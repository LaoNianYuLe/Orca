package com.i.app.ui.navigation
...
import com.i.app.ui.settings.KEY_LAUNCH_SESSION
import com.i.app.ui.settings.getAppearancePrefs
...
import com.i.app.ui.chat.ChatScreen
import com.i.app.ui.sessions.SessionListScreen
import com.i.app.ui.settings.AboutScreen
import com.i.app.ui.settings.AddAgentLoopGroupsScreen
import com.i.app.ui.settings.AddAgentLoopModelsScreen
import com.i.app.ui.settings.AddCustomModelScreen
import com.i.app.ui.settings.BackgroundSettingsScreen
import com.i.app.ui.settings.AddModelsToGroupScreen
import com.i.app.ui.settings.ShadowVoiceDetailScreen
import com.i.app.ui.settings.AddProviderScreen
import com.i.app.ui.settings.ModelEntryDetailScreen
import com.i.app.ui.settings.ModelGroupDetailScreen
import com.i.app.ui.settings.ModelGroupsScreen
import com.i.app.ui.settings.ProviderDetailScreen
import com.i.app.ui.settings.ProviderListScreen
import com.i.app.ui.sandbox.FileBrowserScreen
import com.i.app.ui.sandbox.FileBrowserViewModel
import com.i.app.ui.sandbox.FileItem
import com.i.app.ui.sandbox.FilePreviewScreen
import com.i.app.ui.sandbox.RootfsManagementScreen
import com.i.app.ui.settings.EnvironmentVariablesScreen
import com.i.app.ui.settings.AppearanceScreen
import com.i.app.ui.settings.SettingsScreen
import com.i.app.ui.settings.SystemPermissionsScreen
import com.i.app.ui.settings.SessionStorageDetailScreen
import com.i.app.ui.settings.SkillDetailScreen
import com.i.app.ui.settings.StorageManagementScreen
import com.i.app.ui.settings.SkillFileViewerScreen
import com.i.app.ui.settings.UsageStatsScreen
import com.i.app.ui.settings.ISkillsBrowserScreen
import com.i.app.ui.settings.MountDetailScreen
import com.i.app.ui.settings.MountedFoldersScreen
import com.i.app.ui.settings.SharedFolderDetailScreen
import com.i.app.ui.settings.SharedFoldersScreen
import com.i.app.ui.settings.SkillsManagementScreen
import com.i.app.data.repository.EnvVarRepository
import com.i.app.data.repository.MemoryRepository
import com.i.app.data.repository.SkillRepository
import com.i.app.ui.settings.LogDetailScreen
import com.i.app.ui.settings.LogManagementScreen
import com.i.app.ui.settings.MemoryFileEditScreen
import com.i.app.ui.settings.MemoryManagementScreen
import com.i.app.ui.settings.OffloadPermissionScreen
import com.i.app.ui.settings.ShizukuPermissionScreen
import com.i.app.sandbox.RootfsManager
import com.i.app.sandbox.TerminalSession
import com.i.app.ui.terminal.TerminalScreen
import com.i.app.ui.onboarding.OnboardingModelSelectionScreen
import com.i.app.ui.workspace.CopywritingScreen
import com.i.app.ui.workspace.ProjectsScreen
...
fun AppNavigation(
    ...
    val mountedFoldersStore = remember {
        (context.applicationContext as com.i.app.IApp).mountedFoldersStore
    }
    ...
    LaunchedEffect(Unit) {
        ...
        val hasPendingShare =
            com.i.app.share.ShareCoordinator.bufferVersion.value > 0
    ...
    NavHost(
        ...
        composable(
            ...
            SharedFolderDetailScreen(
                ...
                onBrowseFiles = {
                    ...
                    val hostPath = java.io.File(rootfs.rootfsDir, "var/i/$folderId")
                    val label = when (folderId) {
                        "shared" -> ctx.getString(com.i.app.R.string.shared_folder_name_shared)
                        "skills" -> ctx.getString(com.i.app.R.string.shared_folder_name_skills)
                        "memory" -> ctx.getString(com.i.app.R.string.shared_folder_name_memory)
                        else -> folderId
                    }
        ...
        composable(
            ...
            val category = com.i.app.ui.sandbox.MirrorCatalog.categoryFromKey(categoryKey)
                ?: return@composable
            com.i.app.ui.sandbox.MirrorCategoryDetailScreen(
                category = category,
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(
            ...
            val context = androidx.compose.ui.platform.LocalContext.current
            val rootfs = RootfsManager.getInstance(context.applicationContext)
            val varI = java.io.File(rootfs.rootfsDir, "var/i")
            val sessionId = backStackEntry.arguments?.getString("sessionId") ?: return@composable
            val vm = remember(rootfs.rootfsDir.absolutePath, varI.absolutePath, sessionId) {
        ...
        composable(Routes.SKILLS) {
            if (skillRepository != null) {
                SkillsManagementScreen(
                    ...
                    onISkillsClick = { navController.safeNavigate(Routes.I_SKILLS_BROWSER) },
                )
            }
        }
        ...
        composable(Routes.MCP) {
            if (mcpRepository != null) {
                com.i.app.ui.settings.MCPIntegrationsScreen(
                    mcpRepository = mcpRepository,
                    onBack = { navController.safePopBackStack() },
                    envVarRepository = envVarRepository,
                )
        ...
        composable(Routes.SOUL) {
            com.i.app.ui.settings.SoulSettingsScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.SCHEDULED_TASKS) {
            com.i.app.ui.scheduled.ScheduledTasksScreen(
                onBack = { navController.safePopBackStack() },
                onEditTask = { taskId ->
        ...
        composable(
            ...
            com.i.app.ui.scheduled.ScheduledTaskRunsScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
        ...
        composable(
            ...
            com.i.app.ui.scheduled.ScheduledTaskEditScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
