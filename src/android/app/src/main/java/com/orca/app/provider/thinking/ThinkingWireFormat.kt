 ...
 * [com.orca.app.provider.openai.OpenAIProvider]). Gemini and Anthropic have their
...
sealed interface ThinkingWireFormat {
     ...
     *
     * Mistral (GH I#87): `AssistantMessage` is a closed schema and the request
     * rejects `reasoning` with `422 extra_forbidden`. Venice (GH I#86) is the
     ...
     * official endpoint reasons by default and its real switch lives here; I never
     * sent it, so the official endpoint always ran its default config (GH I#171).
     */
