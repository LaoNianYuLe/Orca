...
/**
 * One configurable setting. Concrete kinds: [com.orca.app.config.fields.PrefsBoolField]
 * etc. for SharedPreferences-backed scalars; [com.orca.app.config.fields.ClosureField]
...
interface ConfigField {
     ...
     * already blocks these entries, and orca-config must not be a side door
     * around that gate.
     *
