 ...
 * in [com.orca.app.provider.thinking.ThinkingRuleResolver.builtInRules] and are
...
data class ProviderThinkingRuleEntity(
    /** Stable UUID assigned at creation; the drag-reorder target and orca-config handle. */
    ...
    /** Serialized [com.orca.app.provider.thinking.ThinkingWireFormat]; null = "no opinion". */
