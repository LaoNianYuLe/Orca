package com.orca.app.notification
 ...
 *
 * Trigger contract: this class is hooked into [com.orca.app.service.SessionActivityTracker]
 * so a session transitioning from active → inactive (i.e. its agent
 * loop completed) deteritically reaches `notifyTaskCompleted`. The
...
class BackgroundTaskNotifier(
    ...
    /**
     * Called by [com.orca.app.service.SessionActivityTracker] when a
