...
import com.orca.app.data.db.AppDatabase
import com.orca.app.data.repository.BackgroundSettingsRepository
...
import com.orca.app.notification.BackgroundTaskNotifier
import com.orca.app.logging.AppLogger
import com.orca.app.network.NetworkMonitor
...
import com.orca.app.sandbox.MountedFolderCoordinator
import com.orca.app.sandbox.NativeOffloadServer
import com.orca.app.sandbox.PRootKernel
import com.orca.app.sandbox.RootfsManager
import com.orca.app.sandbox.offload.AccessibilityOffloadHandler
import com.orca.app.sandbox.offload.AlarmOffloadHandler
import com.orca.app.sandbox.offload.BrowserUseOffloadHandler
import com.orca.app.sandbox.offload.CalendarOffloadHandler
import com.orca.app.sandbox.offload.ClipboardOffloadHandler
import com.orca.app.sandbox.offload.ContactsOffloadHandler
import com.orca.app.sandbox.offload.DeviceOffloadHandler
import com.orca.app.sandbox.offload.LocationOffloadHandler
import com.orca.app.sandbox.offload.ModelUseOffloadHandler
import com.orca.app.sandbox.offload.SessionsOffloadHandler
import com.orca.app.sandbox.offload.ShizukuOffloadHandler
import com.orca.app.sandbox.offload.NotificationOffloadHandler
import com.orca.app.sandbox.offload.OpenOffloadHandler
import com.orca.app.sandbox.offload.PhotosOffloadHandler
import com.orca.app.sandbox.offload.PlayerOffloadHandler
import com.orca.app.sandbox.offload.SpeakOffloadHandler
...
class OrcaApp : Application(), ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        com.orca.app.data.FastModePrefs.prime(this)
        ...
        // Activity context.
        com.orca.app.data.AutoCompactPrefs.prime(this)
        ...
        // libs first execute.
        try {
            com.orca.app.crash.NativeCrashHandler.install(
            ...
            Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
                try {
                    ...
                    if (isFgsTimeout) {
                        ...
                        runCatching {
                            val intent = Intent(this, com.orca.app.service.AgentForegroundService::class.java)
                            stopService(intent)
                        }
                    }
                } catch (t: Throwable) {
        ...
        com.orca.app.crash.CrashFrequencyDetector.checkAtLaunch(this)
        ...
        // [com.orca.app.diagnostics.LaunchCycleBeacon].
        try {
        ...
        com.orca.app.diagnostics.HangDetector.start(this)
        ...
        com.orca.app.data.EnvVarPrivacyStore.init(this)
        com.orca.app.data.EnvVarRedactor.envVarRepository = envVarRepository
        ...
        com.orca.app.service.SessionBadgeStore.init(this)
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            ...
            com.orca.app.service.SessionBadgeStore.reconcileInterruptedSessions(interrupted - active)
        }
        ...
        com.orca.app.config.confirm.ConfigConfirmationGate.backgroundNotifier = {
            configConfirmNotifier.notifyIfBackgrounded(it)
        }
        com.orca.app.config.confirm.ConfigConfirmationGate.cancelNotification = {
        ...
        registerActivityLifecycleCallbacks(object : ActivityLifecycleCallbacks {
            ...
            override fun onActivityResumed(activity: Activity) {
                ...
                com.orca.app.crash.CrashFrequencyDetector.maybeShowOnActivity(activity)
            ...
            override fun onActivityStopped(activity: Activity) {
                ...
                if (foregroundActivityCount == 0) {
                    ...
                    com.orca.app.config.confirm.ConfigConfirmationGate.notifyPending()
                }
            }
