...
abstract class OAuthManager(
    ...
    companion object {
        ...
        fun forInstance(context: Context, instance: com.orca.app.data.model.ProviderInstance): OAuthManager? {
            return when (instance.providerType) {
                com.orca.app.data.model.ProviderType.anthropic -> ClaudeOAuthManager(context, instance.id)
                com.orca.app.data.model.ProviderType.openAI -> OpenAIOAuthManager(context, instance.id)
                com.orca.app.data.model.ProviderType.xAI -> XAIOAuthManager(context, instance.id)
                com.orca.app.data.model.ProviderType.kimiCode -> KimiOAuthManager(context, instance.id)
                else -> null
            }
        }
    }
    ...
    private fun getEncryptedPrefs() =
        com.orca.app.util.EncryptedPrefsFactory.safeCreate(context, "oauth_prefs")
