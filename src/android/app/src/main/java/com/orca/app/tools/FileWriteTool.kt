...
object FileWriteTool {
    ...
    fun execute(argsJson: String, sessionId: String, context: Context): ToolExecutionResult {
        return try {
            ...
            // T123: per-session resolver so /var/orca/workspace/...,
            // /var/orca/attachments/..., /var/orca/offloads/...,
            // /var/orca/browser/... land in this session's host dir
            ...
            // /var/orca/workspace/foo/bar.md would otherwise hit "Parent
            ...
            if (path.startsWith("/var/orca/mounts/")) {
