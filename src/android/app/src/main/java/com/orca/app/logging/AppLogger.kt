...
object AppLogger {
    ...
    private fun startCapture() {
        ...
        // post-crash one.
        appContext?.let { com.orca.app.diagnostics.EnvironmentBanner.log(it) }
    }
     ...
     * itself produced (tag prefix `I.`) are skipped — [log] already wrote
