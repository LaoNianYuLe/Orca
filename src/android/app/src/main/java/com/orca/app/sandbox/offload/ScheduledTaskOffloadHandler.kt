...
import com.orca.app.scheduled.ScheduledRepeatMode
import com.orca.app.scheduled.ScheduledTargetMode
import com.orca.app.scheduled.ScheduledTask
import com.orca.app.scheduled.ScheduledTaskManager
...
class ScheduledTaskOffloadHandler(private val context: Context) : NativeOffloadHandler {
    ...
    private fun handleRun(args: OffloadArgs): NativeOffloadResult {
        ...
        val sessionId = runBlocking {
            com.orca.app.scheduled.ScheduledAgentRunner.run(context, task)
        }
        val out = JSONObject()
            .put("id", id)
