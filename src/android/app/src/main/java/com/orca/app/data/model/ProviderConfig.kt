package com.orca.app.data.model
...
enum class ProviderType(val displayName: String) {
    ...
    kimiCode("Kimi Code"),
    // OpenAI-compatible vendor presets. They intentionally reuse the
    // OpenAIProvider transport rather than introducing duplicate clients.
    poolside("Poolside"),
    inception("Inception");
...
data class ProviderInstance(
    ...
    // an official client (e.g. Claude Code); I' default UA gets rejected.
