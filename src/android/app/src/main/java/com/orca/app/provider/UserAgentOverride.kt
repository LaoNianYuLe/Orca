...
/**
 * [T-android-default-ua] Branded User-Agent used by every I-originated
 * outbound request that doesn't have a SDK-specific UA requirement.
 *
 * Format mirrors iOS exactly:
 *   `I/<version> (Android <release>; <model>)`
 *
 * e.g. `I/0.14-preview (Android 13; Pixel 4a)` — same shape as iOS's
 * `I/1.10 (iOS 26.5; iPhone)`.
 *
...
object OrcaUserAgent {
    val DEFAULT: String by lazy {
        ...
        "I/${BuildConfig.VERSION_NAME} (Android $release; $model)"
    }
}
