...
object CorrectionAdmission {
    ...
    object Config {
         ...
         * admits linux↔i (skeletons lnx/mns, sim 0.33) while rejecting
    ...
    sealed class Verdict {
        ...
        /** Latin near-sound (consonant-skeleton match) — e.g. linux→i. */
     ...
     * positive: linux↔ninja, indistinguishable from linux↔i on every
