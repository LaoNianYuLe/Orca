#!/usr/bin/env python3
"""daemon.py — the forked, long-lived background process behind orca-mcp-cli.
...
import sys
sys.path.insert(0, "/usr/local/lib/orca-mcp-cli")
...
class MCPServerProcess:
    ...
    def _handshake(self):
        # Startup/handshake timeout is per-server configurable (I config,
