...
static BOOL requestHealthKitAccess(NSSet<HKObjectType *> *readTypes,
    ...
    if (!granted && outError) {
        ...
        *outError = [NSString stringWithFormat:
            @"%@. To grant access, open Settings > Health > Data Access & Devices > I "
...
static NSString *const kHKOffloadErrorDomain = @"IHealthKitOffload";
    ...
    if (!saveWithAuthRetry(bpCorrelation, sysType, &saveErr)) {
        ...
        if (authDenied) {
            msg = [NSString stringWithFormat:
                @"%@. Open Settings > Health > Data Access & Devices > I "
