...
static NSString *const HELP_TEXT =
    @"apple-vision - Image analysis using the Vision framework\n"
     ...
     "  Supports images in /var/i/attachments/ and other accessible paths.\n"
     "\n"
     "EXAMPLES:\n"
     "  apple-vision ocr /var/i/attachments/photo.jpg\n"
     "  apple-vision ocr /var/i/attachments/doc.png --lang zh-Hans,en --level fast\n"
     "  apple-vision barcode /var/i/attachments/qr.png --compact -q\n"
     "  apple-vision classify /var/i/attachments/photo.jpg --limit 5\n"
     "  apple-vision analyze /var/i/attachments/photo.jpg\n"
