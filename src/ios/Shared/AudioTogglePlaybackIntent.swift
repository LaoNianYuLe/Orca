...
enum AudioTogglePlaybackBridge {
    ...
    static let darwinNotificationName = "com.i.app.liveActivity.audioToggle"
}
...
struct AudioTogglePlaybackIntent: LiveActivityIntent {
    ...
    static var description = IntentDescription("Toggles play/pause on I audio narration from the Live Activity.")
