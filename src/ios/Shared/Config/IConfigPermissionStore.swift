...
/// top of the entire i-config subsystem. Disabling it short-circuits
...
@MainActor
final class IConfigPermissionStore: ObservableObject {
    static let shared = IConfigPermissionStore()

    static let userDefaultsKey = "permissions.iConfig.enabled"
