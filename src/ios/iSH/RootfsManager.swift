...
class RootfsManager {
    ...
    /// [T-mcp-cli-help-and-readonly-ios] Guest path of the bundled i-mcp-cli
    /// Python lib. Its files are mounted read-only (see applyDefaultMountOverlay).
    private static let mcpCliLibDir = "/usr/local/lib/i-mcp-cli"
    private static let mcpCliLibPrefix = "/usr/local/lib/i-mcp-cli/"
    ...
    func installIfNeeded() throws {
        ...
        // Pre-create /var/i/ shared directory structure
        let iSubdirs = ["var/i/attachments", "var/i/offloads", "var/i/workspace", "var/i/skills", "var/i/shared"]
    ...
    func applyDefaultMountOverlay() {
        ...
        while let fileURL = enumerator.nextObject() as? URL {
            ...
            do {
                ...
                // like /usr/local/bin/i-open are always executable.
                ...
                // [T-mcp-cli-help-and-readonly-ios] The bundled i-mcp-cli
        ...
        // i-mcp-cli lib FILES read-only (0o444), but ensureParentDirsInMetaDB
