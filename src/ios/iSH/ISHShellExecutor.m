...
+ (int)executeCommand:(NSString *)command
    ...
    // — a 100% deteritic failure for any heredoc-terminated command.
...
#define ENVP_APPEND(s) do { \
    ...
    // /usr/local/bin/i-open which emits an OSC marker parsed by the host.
    ENVP_APPEND("BROWSER=/usr/local/bin/i-open");
