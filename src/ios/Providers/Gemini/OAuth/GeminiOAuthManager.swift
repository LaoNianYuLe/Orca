...
final class GeminiOAuthManager: NSObject, ObservableObject {
    ...
    static let legacyKeychainService = "com.i.app.gemini-oauth"
    static let legacyKeychainAccount = "token"
    static let legacyEmailKey = "com.i.app.gemini-email"
    static let legacyProjectIDKey = "com.i.app.gemini-gcp-project"
