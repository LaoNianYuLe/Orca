...
/// stack (NSTextStorage + ILayoutManager + NSTextContainer).
///
...
final class MarkdownRenderView: UIView, UIGestureRecognizerDelegate {
    ...
    let textLayoutManager: ILayoutManager
    ...
    override init(frame: CGRect) {
        ...
        textLayoutManager = ILayoutManager()
    ...
    /// TextKit-1 `ILayoutManager`, so the computation is identical; nil
