...
//  to share i:// files, images, audio, video, links, and previews.
...
struct IShareSheet: UIViewControllerRepresentable {
    let url: URL
    ...
    /// (`I-2026-05-18-205557.ips`): `SHKItemIsPDF` →
    ...
    /// other schemes (i://, file:// with no path, etc.) return
