...
private struct MemoryFileEditView: View {
    ...
    private var fileURL: URL {
        AIChatViewModel.iMemoryPersistentDir.appendingPathComponent(fileName)
    }
    ...
    private func save() {
        let fm = FileManager.default
        try? fm.createDirectory(at: AIChatViewModel.iMemoryPersistentDir, withIntermediateDirectories: true)
        do {
            ...
            IToast.show(String(localized: "Saved"))
...
extension Notification.Name {
    ...
    static let memoryFilesDidChange = Notification.Name("com.i.app.memoryFilesDidChange")
}
