...
/// Inline section for ModelGroupsView — manages models available via i-model-use.
...
struct AgentLoopModelsSection: View {
    ...
    var body: some View {
        Section {
            ...
            Text("Models and groups listed here can be invoked from the terminal via i-model-use. Only these are visible to the agent.")
        }
    }
