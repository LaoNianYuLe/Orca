...
/// its own running / success / failure state. All prompts are short + I-themed.
...
final class TestSession: ObservableObject {
    ...
    private static func performTest(_ kind: ModelQuickTestSheet.Kind, entry: ModelEntry) async throws -> TestRun.State {
        ...
        case .text:
            ...
            let messages = [LLMMessage(
                role: .user,
                content: "Hi! I'm setting you up in I. Say hello back in one short, friendly sentence.")]
        ...
        case .transcription:
            ...
            let spoken = "Hello from I, testing speech to text."
    ...
    private static func makeWAV(from buffers: [AVAudioPCMBuffer]) throws -> Data {
        ...
        let tmpURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("i-quicktest-\(UUID().uuidString).wav")
        do {
