...
struct MCPIntegrationsView: View {
    /// [T-mcp-oauth-deeplink] When set (i://settings/mcp-servers/<id>),
    ...
    var body: some View {
        ...
        // server written by i-mcp-cli after launch shows up without an app
...
/// refresh (`i-mcp-cli refresh <name>`: evict the daemon session,
