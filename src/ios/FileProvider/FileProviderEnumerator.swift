...
final class FileProviderEnumerator: NSObject, NSFileProviderEnumerator {
    ...
    private static let log = OSLog(subsystem: "com.i.app.FileProvider", category: "Enumerator")
    ...
    /// IConfig/, a stale copy might still be around after upgrading —
    ...
    /// Build a compact, deteritic sync anchor from directory contents.
