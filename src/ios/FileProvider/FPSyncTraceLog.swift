...
/// via `debug.readFile path:"AppGroup/IConfig/fp-sync-trace.log"`.
///
...
enum FPSyncTraceLog {
    ...
    private static let queue = DispatchQueue(label: "com.i.app.FileProvider.fpSyncTrace")
    private static let osLog = OSLog(subsystem: "com.i.app.FileProvider", category: "FPSyncTrace")

    private static var fileURL: URL? {
        guard let container = FileManager.default.containerURL(
            forSecurityApplicationGroupIdentifier: "group.com.i.app"
        ) else { return nil }
        let dir = container.appendingPathComponent("IConfig", isDirectory: true)
