...
/// Watches the App Group `IFileProvider/{shared,skills,memory}/` subtrees and
...
final class AppGroupChangeWatcher {
    ...
    private let queue = DispatchQueue(label: "com.i.app.fpwatcher", qos: .utility)
    private let domainIdentifier = NSFileProviderDomainIdentifier("com.i.app.files")
