...
/// from IApp.swift. Wires Syncable types into the registry, registers
...
enum SyncV2Bootstrap {
    ...
    static func setEnabled(_ enabled: Bool) {
        ...
        // builds required a relaunch because boot only ran from IApp
    ...
    /// Called once from IApp launch (or on flag flip in debug builds).
    ...
    static func startIfEnabled() async {
        ...
        Task { @MainActor in
            ...
            do {
                ...
                // Self-register this device into i-devices zone so peers
