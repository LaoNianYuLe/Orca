...
/// [T-mcp-integration-ios] Whole-file sync of /var/i/mcp-servers/servers.json
...
// lives in the i-secrets zone alongside ProviderConfigV2.
...
// <iMemoryPersistentDir>/SOUL.md and is read/written by SoulStore.
...
// Lives alongside SoulV2 in i-shared zone.
