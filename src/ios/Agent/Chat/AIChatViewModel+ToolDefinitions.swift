        ...
        var tools: [AgentToolDefinition] = [
            ...
            AgentToolDefinition(
                ...
                parameters: [
                    ...
                    "path": AgentToolParam(type: .string, description: "Absolute Linux path to read (e.g. /var/i/workspace/data.csv)"),
        ...
        if nativeVision || visionGroupConfigured {
            ...
            tools.append(AgentToolDefinition(
                ...
                parameters: [
                    ...
                    "path": AgentToolParam(type: .string, description: "Linux path (e.g. /var/i/attachments/chart.png) or i:// URL (e.g. i://attachments/chart.png)"),
