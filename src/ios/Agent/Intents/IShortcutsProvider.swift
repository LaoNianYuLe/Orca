...
/// Siri trigger phrases (zh-Hans/zh-Hant, e.g. "问问I") live in
...
@available(iOS 17.0, *)
struct IShortcutsProvider: AppShortcutsProvider {
    static var appShortcuts: [AppShortcut] {
        // Siri-facing "ask I" entry — opens the app and lands in the
