...
///   2. Build an `https://i.app/launch.html?…` URL whose query
...
///      to `i://open?session=…&path=…`, which `DeepLinkRouter` routes
...
///   - a PNG at i.app/icons/category/<rawValue>.png
